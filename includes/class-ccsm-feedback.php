...
class CCSM_Feedback {
        ...
        <script>
            jQuery(document).ready(function ($) {
                var deactivateURL = $("#epsilon-deactivate-link-<?php echo esc_attr( $this->plugin_name ); ?>"),
                    ...
                    detailsStrings = {
                        'setup': '<?php echo __( 'What was the dificult part ?', 'colorlib-coming-soon' ) ?>',
                        'documentation': '<?php echo __( 'What can we describe more ?', 'colorlib-coming-soon' ) ?>',
                        'features': '<?php echo __( 'How could we improve ?', 'colorlib-coming-soon' ) ?>',
                        'better-plugin': '<?php echo __( 'Can you mention it ?', 'colorlib-coming-soon' ) ?>',
                        'incompatibility': '<?php echo __( 'With what plugin or theme is incompatible ?', 'colorlib-coming-soon' ) ?>',
                    };
	...
	public function get_form_info() {
		...
		$form['options'] = array(
			...
			'documentation'   => __( 'Lack of documentation', 'colorlib-coming-soon' ),
			'features'        => __( 'Not the features I wanted', 'colorlib-coming-soon' ),
			'better-plugin'   => __( 'Found a better plugin', 'colorlib-coming-soon' ),
			'incompatibility' => __( 'Incompatible with theme or plugin', 'colorlib-coming-soon' ),
		);
		$form['details'] = __( 'How could we improve ?', 'colorlib-coming-soon' );
