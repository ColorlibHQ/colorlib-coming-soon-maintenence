...
?>
    ...
    <div class="flex-col-c-sb size1 overlay1">
        ...
        <div class="flex-col-c-m p-l-15 p-r-15 p-t-50 p-b-120">
            <h1 class="l1-txt1 txt-center p-b-40 respon1" id="colorlib_coming_soon_page_heading">
			...
			<?php if ( $ccsm_counter_activation == '1' ) { ?>
                <div class="flex-w flex-c-m cd100">
                    <div class="flex-col-c wsize1 m-b-30">
                        <span class="l1-txt2 p-b-9 days"><?php echo esc_html( $ccsm_dates['template']['days'] ); ?></span>
                        <span class="s1-txt1 where1 p-l-35"><?php echo esc_html__( 'Days', 'colorlib-coming-soon-maintenance' ); ?></span>
                    </div>

                    <div class="flex-col-c wsize1 m-b-30">
                        <span class="l1-txt2 p-b-9 hours"><?php echo esc_html( $ccsm_dates['template']['hours'] ); ?></span>
                        <span class="s1-txt1 where1 p-l-35"><?php echo esc_html__( 'Hours', 'colorlib-coming-soon-maintenance' ); ?></span>
                    </div>

                    <div class="flex-col-c wsize1 m-b-30">
                        <span class="l1-txt2 p-b-9 minutes"><?php echo esc_html( $ccsm_dates['template']['minutes'] ); ?></span>
                        <span class="s1-txt1 where1 p-l-35"><?php echo esc_html__( 'Minutes', 'colorlib-coming-soon-maintenance' ); ?></span>
                    </div>

                    <div class="flex-col-c wsize1 m-b-30">
                        <span class="l1-txt2 p-b-9 seconds"><?php echo esc_html( $ccsm_dates['template']['seconds'] ); ?></span>
        ...
        <p style="color:#fff;" class="colorlib-copyright"><span><?php esc_html_e('Coming Soon Template designed by','colorlib-coming-soon-maintenance'); ?></span> <a
                    href="https://colorlib.com/" target="_blank" rel="noopener noreferrer" style="color:#fff;">Colorlib</a></p>
    </div>
<?php
