			...
			<?php if ( $ccsm_counter_activation == '1' ) { ?>
                <div class="flex-w flex-c cd100 respon2">
                    <div class="flex-col-c wsize1 m-b-30">
                        <span class="l1-txt2 p-b-37 days"><?php echo esc_html( $ccsm_dates['template']['days'] ); ?></span>
                    ...
                    <div class="flex-col-c wsize1 m-b-30">
                        <span class="l1-txt2 p-b-37 hours"><?php echo esc_html( $ccsm_dates['template']['hours'] ); ?></span>
                    ...
                    <div class="flex-col-c wsize1 m-b-30">
                        <span class="l1-txt2 p-b-37 minutes"><?php echo esc_html( $ccsm_dates['template']['minutes'] ); ?></span>
                    ...
                    <div class="flex-col-c wsize1 m-b-30">
                        <span class="l1-txt2 p-b-37 seconds"><?php echo esc_html( $ccsm_dates['template']['seconds'] ); ?></span>
